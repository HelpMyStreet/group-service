...
{
    public partial class GroupLocations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GROUP_LOCATION", x => new { x.GroupID, x.LocationID });
                    table.ForeignKey(
                        name: "FK_GroupLocation_Group",
                        column: x => x.GroupID,
