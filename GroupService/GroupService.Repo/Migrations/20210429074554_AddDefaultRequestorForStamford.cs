...
{
    public partial class AddDefaultRequestorForStamford : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "Lakeside Healthcare Group", "Unit 1 Exchange Court", "Cottingham Road", "lyndsay.money@nhs.net", "Lyndsay", "Money", "Corby", "01780 761443", "NN17 1TY" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyValue: -17,
                columns: new[] { "AddressLine1", "AddressLine2", "AddressLine3", "EmailAddress", "FirstName", "LastName", "Locality", "OtherPhone", "Postcode" },
                values: new object[] { "Lakeside Healthcare at Stamford", "Wharf Rd", "Stamford", "laura@factor-50.co.uk", "Stamford", "PCN", "", "", "PE9 2DH" });
