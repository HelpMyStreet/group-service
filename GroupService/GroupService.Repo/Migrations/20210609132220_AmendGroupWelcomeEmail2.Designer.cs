...
namespace GroupService.Repo.Migrations
{
    ...
    [Migration("20210609132220_AmendGroupWelcomeEmail2")]
    partial class AmendGroupWelcomeEmail2
    {
            ...
            modelBuilder.Entity("GroupService.Repo.EntityFramework.Entities.GroupEmailConfiguration", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            GroupId = -2,
                            CommunicationJobTypeId = (byte)15,
                            Configuration = "[{\"Key\":\"GroupContent\",\"Value\":\"Before you start volunteering with us we need to verify your ID – this is to make things as safe as possible for you and the people we help.\"},{\"Key\":\"GroupSignature\",\"Value\":\"Best wishes,</p><p>For the Love of Scrubs\"},{\"Key\":\"GroupPS\",\"Value\":\"\"},{\"Key\":\"ShowGroupLogo\",\"Value\":\"true\"},{\"Key\":\"ShowGroupRequestFormLink\",\"Value\":\"false\"}]"
                        },
                        new
                        {
                            GroupId = -3,
                        ...
                        new
                        {
                            GroupId = -4,
                            CommunicationJobTypeId = (byte)15,
                            Configuration = "[{\"Key\":\"GroupContent\",\"Value\":\"Before you start volunteering with us we need to verify your ID – this is to make things as safe as possible for you and the people we help.\"},{\"Key\":\"GroupSignature\",\"Value\":\"Best wishes,</p><p>Healthy London Partnership\"},{\"Key\":\"GroupPS\",\"Value\":\"\"},{\"Key\":\"ShowGroupLogo\",\"Value\":\"true\"},{\"Key\":\"ShowGroupRequestFormLink\",\"Value\":\"false\"}]"
                        },
                        new
                        {
                            GroupId = -5,
                        ...
                        new
                        {
                            GroupId = -7,
                            CommunicationJobTypeId = (byte)15,
                            Configuration = "[{\"Key\":\"GroupContent\",\"Value\":\"<p>Before you start volunteering with us we need to verify your ID – this is to make things as safe as possible for you and the people we help. You can verify your ID online, or if you’re having trouble email us at <a href=\\\"mailto:volunteers@ageukwirral.org.uk>volunteers@ageukwirral.org.uk</a>.</p><p>For some activities we will also need a DBS check. Please email us on the email address above to request or register your DBS check.</p>\"},{\"Key\":\"GroupSignature\",\"Value\":\"Best wishes,</p><p>Age UK Wirral\"},{\"Key\":\"GroupPS\",\"Value\":\"Questions? Drop us an email at <a href=\\\"mailto:ruddington@helpmystreet.org\\\">ruddington@helpmystreet.org</a>.\"},{\"Key\":\"ShowGroupRequestFormLink\",\"Value\":\"false\"},{\"Key\":\"ShowGroupLogo\",\"Value\":\"true\"}]"
                        },
                        new
                        {
                            GroupId = -8,
                        ...
                        new
                        {
                            GroupId = -12,
                            CommunicationJobTypeId = (byte)15,
                            Configuration = "[{\"Key\":\"GroupContent\",\"Value\":\"\"},{\"Key\":\"GroupSignature\",\"Value\":\"Best wishes,</p><p>The Lincolnshire Volunteers Team\"},{\"Key\":\"GroupPS\",\"Value\":\"\"},{\"Key\":\"ShowGroupRequestFormLink\",\"Value\":\"false\"}]"
                        },
                        new
                        {
                            GroupId = -13,
                        ...
                        new
                        {
                            GroupId = -14,
                            CommunicationJobTypeId = (byte)15,
                            Configuration = "[{\"Key\":\"GroupContent\",\"Value\":\"\"},{\"Key\":\"GroupSignature\",\"Value\":\"\"},{\"Key\":\"GroupPS\",\"Value\":\"\"},{\"Key\":\"ShowGroupRequestFormLink\",\"Value\":\"false\"},{\"Key\":\"ShowGroupLogo\",\"Value\":\"True\"}]"
                        },
                        new
                        {
                            GroupId = -15,
                            CommunicationJobTypeId = (byte)15,
                            Configuration = "[{\"Key\":\"GroupContent\",\"Value\":\"\"},{\"Key\":\"GroupSignature\",\"Value\":\"\"},{\"Key\":\"GroupPS\",\"Value\":\"\"},{\"Key\":\"ShowGroupRequestFormLink\",\"Value\":\"false\"},{\"Key\":\"ShowGroupLogo\",\"Value\":\"False\"}]"
                        },
                        new
                        {
                            GroupId = -16,
                        ...
                        new
                        {
                            GroupId = -22,
                            CommunicationJobTypeId = (byte)15,
                            Configuration = "[{\"Key\":\"GroupContent\",\"Value\":\"<p>Before you start volunteering with us we need to verify your ID – this is to make things as safe as possible for you and the people we help.</p><p>For some roles, we may also require additional checks or training – we will let you know if any additional checks are needed before accept a request.</p>\"},{\"Key\":\"GroupSignature\",\"Value\":\"\"},{\"Key\":\"GroupPS\",\"Value\":\"Questions? Drop us an email at <a href=\\\"mailto:contact@helpmystreet.org\\\">contact@helpmystreet.org</a>.\"},{\"Key\":\"ShowGroupRequestFormLink\",\"Value\":\"false\"},{\"Key\":\"ShowGroupLogo\",\"Value\":\"true\"}]"
                        },
                        new
                        {
                            GroupId = -23,
                        ...
                        new
                        {
                            GroupId = -25,
                            CommunicationJobTypeId = (byte)15,
                            Configuration = "[{\"Key\":\"GroupContent\",\"Value\":\"\"},{\"Key\":\"GroupSignature\",\"Value\":\"Best wishes,</p><p>Mansfield CVS</p>\"},{\"Key\":\"GroupPS\",\"Value\":\"\"},{\"Key\":\"ShowGroupRequestFormLink\",\"Value\":\"false\"},{\"Key\":\"ShowGroupLogo\",\"Value\":\"True\"}]"
                        },
                        new
                        {
                            GroupId = -27,
