...
namespace GroupService.Repo.Migrations
{
    ...
    [Migration("20210526133611_AmendGroupWelcomeText4")]
    partial class AmendGroupWelcomeText4
    {
            ...
            modelBuilder.Entity("GroupService.Repo.EntityFramework.Entities.GroupEmailConfiguration", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            GroupId = -8,
                            CommunicationJobTypeId = (byte)15,
                            Configuration = "[{\"Key\":\"HeaderRequired\",\"Value\":\"0\"},{\"Key\":\"GroupContent\",\"Value\":\"\"},{\"Key\":\"GroupSignature\",\"Value\":\"\"},{\"Key\":\"GroupPS\",\"Value\":\"<p>Questions? Email us at <a href=\\\"mailto:baldertoncs@helpmystreet.org\\\">baldertoncs@helpmystreet.org</a></p><p>P.S. Don’t forget that you can submit a request for help at any time if there’s someone far away from home that you’re worried about. Complete our <a href=\\\"{{BaseUrl}}/request-help/{{EncodedGroupId}}\\\">Request Help form</a> and let us know what they need.</p>\"}]"
                        },
                        new
                        {
                            GroupId = -9,
                        ...
                        new
                        {
                            GroupId = -10,
                            CommunicationJobTypeId = (byte)15,
                            Configuration = "[{\"Key\":\"HeaderRequired\",\"Value\":\"0\"},{\"Key\":\"GroupContent\",\"Value\":\"\"},{\"Key\":\"GroupSignature\",\"Value\":\"\"},{\"Key\":\"GroupPS\",\"Value\":\"<p>Questions? Email us at <a href=\\\"mailto:northmuskham@helpmystreet.org\\\">northmuskham@helpmystreet.org</a><p>P.S. Don’t forget that you can submit a request for help at any time if there’s someone far away from home that you’re worried about. Complete our <a href=\\\"{{BaseUrl}}/request-help//{{EncodedGroupId}}\\\">Request Help form</a> and let us know what they need.</p>\"}]"
                        },
                        new
                        {
                            GroupId = -11,
